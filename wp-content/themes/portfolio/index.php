...
<head>
    ...
    <link rel="icon" href="img/icon_32x32.ico">
    <link rel="stylesheet" href="re_css/style.css">
    <link rel="stylesheet" href="re_css/normalize.css">
    <title>NishioRyoma</title>
    ...
    <section class="contact flex" id="contact">
        ...
        <div class="bg contactbg">
            ...
            <div class="sns instagram">
                <ion-icon name="logo-instagram"></ion-icon><p>INSTAGRAM</p>
            </div>
            <div class="sns twitter">
                <ion-icon name="logo-twitter"></ion-icon><p>TWITTER</p>
            </div>
            <div class="sns mail">
                <ion-icon name="mail-open-outline"></ion-icon><p>MAIL</p>
            </div>
        </div>
        <p class="OR">OR</p>
